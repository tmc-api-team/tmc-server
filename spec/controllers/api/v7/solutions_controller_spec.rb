...
describe Api::V7::SolutionsController, type: :controller do
  ...
  describe 'GET show' do
    ...
    describe 'with .zip format' do
      ...
      it 'should offer the solution as a downloadable zip', driver: :rack_test do
        visit "/api/v7/exercises/#{@course.exercises.find_by(name: "MyExercise").id}.zip?access_token=#{:token}"
